    ...
    <div class="col-md-12">
      <form action="{{ route('admin.partner.update', $partner->id) }}" method="POST">
        ...
        <div class="form-group">
          ...
          <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" name="name" type="text" value="{{ $partner->name }}">
          @if ($errors->has('name'))
        ...
        <div class="form-group">
          ...
          <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" id="discount" name="discount" type="text" value="{{ $partner->discount }}">
